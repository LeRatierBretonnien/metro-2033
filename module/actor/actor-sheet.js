  ...
  activateListeners(html) {
    ...
    html.find(".roll-weapon").click((event) => {
      ...
      if (weapon.system.category === "melee") {
        skill = this.actor.items.find((i) => i.type == "skill" && i.name.toLowerCase() == "corps à corps");
      } else {
        skill = this.actor.items.find((i) => i.type == "skill" && i.name.toLowerCase() == "tir");
      }
      if (!skill) {
        skill = {
          system: {
